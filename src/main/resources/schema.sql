...
create table appointments (appointmentid bigint not null, date_time timestamp, diagnosis varchar(255), price integer, recommendations varchar(255), type integer, doctor_id bigint, user_id bigint, primary key (appointmentid))
...
alter table appointments add constraint FKrkfom7d38247woglihgd52xwb foreign key (doctor_id) references doctors
alter table appointments add constraint FK82f5p3887lqhpr6xwv26x9gpx foreign key (user_id) references users
